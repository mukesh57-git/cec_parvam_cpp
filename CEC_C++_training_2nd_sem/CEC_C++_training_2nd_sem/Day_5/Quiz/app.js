/**
 * Day 5 Quiz App - Game Engine with Rooms and Persistence
 * Topic: Inheritance in C++
 * Features:
 * - 7 persistent Rooms saved in localStorage (survives refreshes and tab closure)
...
// Using day5-specific key so rooms don't clash with Day 1
const STORAGE_KEY = 'parvam_quiz_rooms_day5';
...
class ConfettiEngine {
  constructor(canvasId) {
    ...
    this.particles = [];
    this.active = false;
    this.colors = ['#34d399', '#00f0ff', '#ff007f', '#6ee7b7', '#ffaa00', '#3b82f6'];
  }
